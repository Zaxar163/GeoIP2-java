...
public class Country extends AbstractNamedRecord {
	...
	public Country(@JacksonInject("locales") List<String> locales, @JsonProperty("confidence") Integer confidence,
	...
	// do a major release.
	public Country(List<String> locales, Integer confidence, Integer geoNameId, String isoCode,
			Map<String, String> names) {
		this(locales, confidence, geoNameId, false, isoCode, names);
	}

	/**
	 * @return A value from 0-100 indicating MaxMind's confidence that the country
	 *         is correct. This attribute is only available from the Insights end
	...
	/**
	 * @return The <a href="http://en.wikipedia.org/wiki/ISO_3166-1">two-character
	 *         ISO 3166-1 alpha code</a> for the country. This attribute is returned
	 *         by all end points.
	 */
	...
	/**
	 * @return This is true if the country is a member state of the European Union.
	 *         This attribute is returned by all location services and databases.
	 */
