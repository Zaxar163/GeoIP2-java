...
public final class Postal extends AbstractRecord {
	...
	/**
	 * @return The postal code of the location. Postal codes are not available for
	 *         all countries. In some countries, this will only contain part of the
	 *         postal code. This attribute is returned by all end points except the
	 *         Country end point.
	 */
	...
	/**
	 * @return A value from 0-100 indicating MaxMind's confidence that the postal
