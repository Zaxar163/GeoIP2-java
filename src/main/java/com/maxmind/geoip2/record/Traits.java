...
public final class Traits extends AbstractRecord {
	...
	public Traits(@JsonProperty("autonomous_system_number") Integer autonomousSystemNumber,
			...
			@JsonProperty("connection_type") ConnectionType connectionType, @JsonProperty("domain") String domain,
			...
			@JsonProperty("is_tor_exit_node") boolean isTorExitNode, @JsonProperty("isp") String isp,
			@JsonProperty("organization") String organization, @JsonProperty("user_type") String userType) {
	...
	// removed.
	public Traits(Integer autonomousSystemNumber, String autonomousSystemOrganization, ConnectionType connectionType,
			String domain, String ipAddress, boolean isAnonymousProxy, boolean isLegitimateProxy,
			boolean isSatelliteProvider, String isp, String organization, String userType) {
		this(autonomousSystemNumber, autonomousSystemOrganization, connectionType, domain, ipAddress, false,
				isAnonymousProxy, false, false, isLegitimateProxy, false, isSatelliteProvider, false, isp, organization,
				userType);
	}

	// This is for back-compat. If we ever do a major release, it should be
	// removed.
	public Traits(Integer autonomousSystemNumber, String autonomousSystemOrganization, String domain, String ipAddress,
			boolean isAnonymousProxy, boolean isSatelliteProvider, String isp, String organization, String userType) {
		this(autonomousSystemNumber, autonomousSystemOrganization, null, domain, ipAddress, isAnonymousProxy, false,
				isSatelliteProvider, isp, organization, userType);
	}
	 ...
	 *         end points and the GeoIP2 Enterprise database.
	 */
	...
	/**
	 * @return The organization associated with the registered
	 *         <a href="http://en.wikipedia.org/wiki/Autonomous_system_(Internet)"
	 *         >autonomous system number</a> for the IP address. This attribute is
	 *         only available from the City and Insights web service end points and
	...
	/**
	 * @return The second level domain associated with the IP address. This will be
	 *         something like "example.com" or "example.co.uk", not
	 *         "foo.example.com". This attribute is only available from the City and
	...
	/**
	 * @return The IP address that the data in the model is for. If you performed a
	 *         "me" lookup against the web service, this will be the externally
	 *         routable IP address for the system the code is running on. If the
	 *         system is behind a NAT, this may differ from the IP address locally
	 *         assigned to it. This attribute is returned by all end points.
	 */
	...
	/**
	 * @return The name of the ISP associated with the IP address. This attribute is
	 *         only available from the City and Insights web service end points and
	 *         the GeoIP2 Enterprise database.
	 */
	...
	/**
	 * @return This is true if the IP address is registered to an anonymous VPN
	 ...
	 *         isHostingProvider. This is only available from GeoIP2 Precision
	 *         Insights.
	 */
	...
	/**
	 * @return This is true if the IP address belongs to a hosting or VPN provider
	 *         (see description of isAnonymousVpn). This is only available from
	...
	/**
	 * @return True if MaxMind believes this IP address to be a legitimate proxy,
	 *         such as an internal VPN used by a corporation. This is only available
	 *         in the GeoIP2 Enterprise database.
	 */
	...
	/**
	 * @return This is true if the IP address belongs to a public proxy. This is
	...
	/**
	 * @return This is true if the IP belong to a satellite Internet provider. This
	...
	/**
	 * @return This is true if the IP address belongs to a Tor exit node. This is
	 *         only available from GeoIP2 Precision Insights.
	 */
