...
/**
 * {@code Downloader} responsible for downloading the currently available
 * database and it's related checksum.
 */
public class DatabaseDownloader implements Closeable {
	/**
	 * <p>
	 * {@code Builder} creates instances of {@code DatabaseDownloader} from values
	 * set by the methods.
	 * </p>
	 * <p>
	 * This example shows how to create a {@code DatabaseDownloader} object with the
	 * {@code Builder}:
	 * </p>
	 * <p>
	 * DatabaseDownloader client = new
	 * DatabaseDownloader.Builder("GeoIP2-City","licensekey").build();
	 * </p>
	 * <p>
	...
	public static final class Builder {
		...
		/**
		 * @return an instance of {@code DatabaseDownloader} created from the fields set
		 *         on this builder.
		 */
		...
		/**
		 * @param val Timeout in milliseconds to establish a connection to the service.
		 ...
		 *            connection to the service. The default is 20000 (20 seconds).
		 * @return Builder object
		 */
	...
	private <T> T handleResponse(CloseableHttpResponse response, URL url, ResponseHandler<T> handler)
			throws IOException {
