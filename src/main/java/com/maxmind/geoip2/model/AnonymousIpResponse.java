...
public class AnonymousIpResponse extends AbstractResponse {
	...
	public AnonymousIpResponse(@JacksonInject("ip_address") @JsonProperty("ip_address") String ipAddress,
			@JsonProperty("is_anonymous") boolean isAnonymous, @JsonProperty("is_anonymous_vpn") boolean isAnonymousVpn,
	...
	/**
	 * @return whether the IP address is registered to an anonymous VPN provider. If
	 *         a VPN provider does not register subnets under names associated with
	 *         them, we will likely only flag their IP ranges using
	 *         isHostingProvider.
	 */
	...
	/**
	 * @return whether the IP address belongs to a hosting or VPN provider (see
