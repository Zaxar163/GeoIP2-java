...
public abstract class AbstractCountryResponse extends AbstractResponse {
	...
	AbstractCountryResponse(Continent continent, Country country, MaxMind maxmind, Country registeredCountry,
			RepresentedCountry representedCountry, Traits traits) {
	...
	/**
	 * @return Country record for the requested IP address. This object represents
	 *         the country where MaxMind believes the end user is located.
	 */
	...
	/**
	 * @return Registered country record for the requested IP address. This record
