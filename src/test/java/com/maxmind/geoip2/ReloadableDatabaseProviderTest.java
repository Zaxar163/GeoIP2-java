...
public class ReloadableDatabaseProviderTest {
	...
	private void assertFailedRead(DatabaseReader.Builder builder, Callable<Boolean> availableChecker,
			boolean lazyInitialization) throws IOException, GeoIp2Exception, UnknownHostException {
		try (ReloadableDatabaseProvider reader = new ReloadableDatabaseProvider(builder, availableChecker,
				lazyInitialization)) {
